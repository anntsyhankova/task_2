...
public class TripDropBox {
    ...
    private List<TripTypeWrapper> getDropBoxValues(){
        return this.element.findElements(tripTypeSelector).stream().map(TripTypeWrapper::new).collect(Collectors.toList());
    }
}
